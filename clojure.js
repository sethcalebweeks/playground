...
$($.add, 1, $($.sub, 3, 2)); // 1 + (3 - 2) => 2

// Types

// If you want to create a literal list of data, use []
[$.add, 1, 2]; // => [ [Function: add], 1, 2 ]
...
// Conj will add an item to the end of an array.
$($.conj, [1, 2, 3], 4); // => [1, 2, 3, 4]

// Use concat to add lists together
...
$($.fn, [], ["Hello World"]); // [Function (anonymous)]
...
$($.defn, "hello", ["name"], [$.add, "Hello ", $`name`]);
